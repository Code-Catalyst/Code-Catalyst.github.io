        ...
        <?php
          ...
          if ($row > 0){
            ...
            <?php
              ...
              $your_php_location = "HOM-posts.php";
            ...
            ?>  
              ...
              <div class="row d-flex justify-content-between align-items-center w-100">
                ...
                <div class="button-container col-5">
                  ...
                  <a href="HOM-drafts.php" data-toggle="tooltip" data-placement="bottom" title="Drafts">
                    <button type="button" class="primary-button icon-button" id="drafts"><i class='bx bx-notepad'></i></button>
                  </a>
                  <a href="HOM-schedules.php" data-toggle="tooltip" data-placement="bottom" title="Schedules">
                    <button type="button" class="primary-button icon-button" id="schedules"><i class='bx bx-alarm'></i></button>
                  </a>
                  ...
                  <script>
                    $(document).ready(function() {
                      $("#event-edit-btn<?php echo $row['post_id'];?>").click(function(event) {
                        ...
                        window.location.href = "HOM-edit-post.php?eec=<?php echo $row['post_id']?>";
                      });
                    });

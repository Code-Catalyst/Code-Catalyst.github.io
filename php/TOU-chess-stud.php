...
$sql = "SELECT scoring_team_a FROM scores WHERE score_id = 3";
...
$sql = "SELECT scoring_team_b FROM scores WHERE score_id = 3";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
...
<html lang="en">
  ...
  <div class="container-fluid" id="popup">
    ...
    <section class="home-section">
      <header class="header">Chess Live Scoring</header>
      <div class="container">
        <div class="home">
            <h1>ELITE</h1>

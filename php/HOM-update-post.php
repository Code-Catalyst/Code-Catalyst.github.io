<?php
    ...
    if(isset($_POST['save_schedule'])){
        ...
        $sql_update_post = "UPDATE post 
        SET post_calendar = '$calendar', organization_id = '$tag', post_title = '$title', post_description = '$description', post_draft = '0'
        WHERE post_id = $id";
        mysqli_query($conn,$sql_update_post);
        to_log($conn, $sql_update_post);

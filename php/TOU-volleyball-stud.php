...
$sql = "SELECT scoring_team_a FROM scores WHERE score_id = 2";
...
$sql = "SELECT scoring_team_b FROM scores WHERE score_id = 2";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
...
<html lang="en">
  ...
  <div class="container-fluid" id="popup">
    ...
    <section class="home-section">
      <header class="header">Volleyball Live Scoring</header>
      <div class="container">
        <div class="home">
            <h1>ELITE</h1>
...
<script>
        ...
        dropdown.addEventListener("change", function() {
            ...
            switch (selectedValue) {
                case "BASKETBALL":
                    window.location.href = "./TOU-basketball-stud.php";
                    break;
                case "VOLLEYBALL":
                    window.location.href = "./TOU-volleyball-stud.php";
                    break;
                case "CHESS":
                    window.location.href = "./TOU-chess-stud.php";
                    break;
                case "BADMINTON":
                    window.location.href = "./TOU-badminton-stud.php";
                    break;
                default:
